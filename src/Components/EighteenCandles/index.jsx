...
const GatsbyContainer = styled(Container)`
  padding: 0;
  color: #CF0A0A;
  background-image: url(${eighteenCandlesBG});
        ...
        <GatsbyContainer maxWidth="2xl">
            ...
            <Box sx={{ 
                ...
                <Box sx={{ 
                    ...
                    borderRadius: '10px',
                    margin: { xs: '20px 0', md: '0 20px 0 0' }
                }} color='#EEEEEE'>
                    <Typography 
                        variant="h6" 
                        letterSpacing={4}
                    ...
                    >
                        Illuminating Wishes and Dreams
                    </Typography>
                    <GatsbyTitle 
                        variant="h2" 
                        component="h1" 
                    ...
                    >
                        Cherished women light the path ahead, each flame carrying wisdom and blessings for the debutante
                    </Typography>
                    {error && (
