...
const GatsbyContainer = styled(Container)`
  padding: 0;
  color: #CF0A0A;
  background-image: url(${eighteenBlueBillsBG});
        ...
        <GatsbyContainer maxWidth="2xl">
            ...
            <Box sx={{ 
                ...
                <Box sx={{ 
                    ...
                    >
                        Honored guests present their wishes for abundance and success through the symbolic blue bill
                    </Typography>
                    {error && (
